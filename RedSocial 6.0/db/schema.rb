...
ActiveRecord::Schema.define(:version => 20101027103423) do
  ...
  create_table "tog_forum_forums", :force => true do |t|
    t.string   "title"
    t.integer  "user_id"
    t.string   "id_referencia"
    t.string   "tipo"
  ...
  create_table "tog_forum_posts", :force => true do |t|
    t.integer  "topic_id"
    t.integer  "user_id"
    t.text     "body"
    t.datetime "created_at"
  ...
  create_table "tog_forum_topics", :force => true do |t|
    t.integer  "forum_id"
    t.integer  "user_id"
    t.string   "title"
    t.text     "body"
