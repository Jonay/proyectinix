ActionController::Routing::Routes.draw do |map|
  ...
  #Añadimos las rutas para mostrar todos los perfiles tanto de las pymes como de los usuarios.
  map.all_pymes 'profile/pymes', :controller => 'profiles', :action => 'pymes'
  
  map.all_users 'profile/users', :controller => 'profiles', :action => 'users'
