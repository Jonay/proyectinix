...
class Event < ActiveRecord::Base
  ...
  validates_presence_of :title, :message => I18n.t("tog_conclave.model.title")
  validates_presence_of :description, :message => I18n.t("tog_conclave.model.description")
  validates_presence_of :venue, :message => I18n.t("tog_conclave.model.venue") 
  validates_presence_of :start_date, :message => I18n.t("tog_conclave.model.start_date")
  validates_presence_of :end_date, :message => I18n.t("tog_conclave.model.end_date")
  validates_presence_of :start_time, :message => I18n.t("tog_conclave.model.start_time")
  validates_presence_of :end_time, :message => I18n.t("tog_conclave.model.end_time")
  validates_presence_of :id_referencia, :message => I18n.t("tog_conclave.model.select_for_who")
