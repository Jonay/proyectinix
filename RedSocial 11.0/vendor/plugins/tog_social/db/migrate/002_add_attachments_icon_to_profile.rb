class AddAttachmentsIconToProfile < ActiveRecord::Migration
  def self.up
    ...
    add_column :profiles, :pdf_file_name,    :string
    add_column :profiles, :pdf_content_type, :string
    add_column :profiles, :pdf_file_size,    :integer
    add_column :profiles, :pdf_updated_at,   :datetime
    ...
    remove_column :profiles, :pdf, :old_file_name
  ...
  def self.down
    ...
    add_column :profiles, :pdf, :string
    ...
    remove_column :profiles, :pdf_file_name
    remove_column :profiles, :pdf_content_type
    remove_column :profiles, :pdf_file_size
    remove_column :profiles, :pdf_updated_at
